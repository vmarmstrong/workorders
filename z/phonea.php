...
if(empty($_GET)){
	if(empty($_POST)){
		...
		$updatesql="INSERT INTO r_phone SET residentId=$rid, phone='$phone', type='$type'";
...
<div id="bgmid">
	<div id="content">
		...
		<div id="display"><!-- ========= location of all result content -->
				<form action="phonea.php" method="post" class="resident">
					<fieldset>
						...
						<div class="ques">
							<p class="l"><label for="type">Phone Type (mobile, work...)</label></p>
